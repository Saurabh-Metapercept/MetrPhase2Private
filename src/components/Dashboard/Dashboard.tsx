...
import { BarChart2, Table as TableIcon, Activity, ScrollText } from 'lucide-react';
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            <div className="bg-white/50 border border-[#E2E8F0]/50 rounded-[10px] p-1 flex gap-1">
              <button
                ...
                className={`${viewMode === 'chart' ? 'bg-white shadow text-[#0F172B]' : 'text-[#62748E]'} rounded-lg px-3 py-1 text-sm flex items-center gap-1 min-h-[36px]`}
              >
                <BarChart2 size={14} />
                Chart
              </button>
              <button
                ...
                className={`${viewMode === 'table' ? 'bg-white shadow text-[#0F172B]' : 'text-[#62748E]'} rounded-lg px-3 py-1 text-sm flex items-center gap-1 min-h-[36px]`}
              >
                <TableIcon size={14} />
                Table
              </button>
      ...
      <div className="bg-white rounded-2xl border border-[#E2E8F0]/60">
        <div className="border-b border-[#E2E8F0] flex">
          <button
            ...
            className={`flex-1 ${activeTab === 'activities' ? 'text-[#5F4050] border-b-2 border-[#5F4050]' : 'text-[#45556C]'} text-sm sm:text-base py-4 text-center flex items-center justify-center gap-1.5 min-h-[44px]`}
          >
            <Activity size={15} />
          ...
          <button
            ...
            className={`flex-1 ${activeTab === 'release' ? 'text-[#5F4050] border-b-2 border-[#5F4050]' : 'text-[#45556C]'} text-sm sm:text-base py-4 text-center flex items-center justify-center gap-1.5 min-h-[44px]`}
          >
            <ScrollText size={15} />
